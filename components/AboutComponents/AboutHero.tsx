        ...
        <div
          ...
          <div className="flex h-full items-center justify-center">
            <div className="px-6 text-center text-white md:px-12">
              ...
              <p className='mt-4 mb-8 xs:text-lg md:text-xl font-semibold'> Our commitment goes beyond providing top-notch vehicles. Join us, and let&apos;s turn moments into memories together.</p>
              <Link href={"/tours"}>
                <button type="button"
