  ...
  return (
    <>
      <div className='flex flex-col items-center justify-center gap-10 mt-24'>
        <h1 className='text-3xl font-bold text-center'>Discover Hvar&apos;s Essence with CroQuad </h1>
      ...
      <h1 className='text-3xl font-bold text-center my-24'>CroQuad Story</h1>
      ...
      <li className="mb-10 ms-4 relative">
        ...
        <time className="mb-1 ml-4 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">February 2024</time>
      ...
      <li className="mb-10 ms-4 relative">
        <div className="absolute w-3 h-3 bg-gray-200 rounded-full mt-1.5 -start-1.5 border border-white dark:border-gray-900 dark:bg-gray-700"></div>
        <time className="mb-1 ml-4 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">Summer 2024</time>
      ...
      <li className="mb-10 ms-4 relative">
        <div className="absolute w-3 h-3 bg-gray-200 rounded-full mt-1.5 -start-1.5 border border-white dark:border-gray-900 dark:bg-gray-700"></div>
        <time className="mb-1 ml-4 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">Continous Connection</time>
