...
const features = [
    {
      ...
      icon: quadIcon,
      alt: "quad-icon",
      quote: "Our state-of-the-art ATV equipment ensures a safe and thrilling adventure."
    },
    {
      title: "Exciting Routes",
      icon: routeIcon,
      alt: "route-icon",
      quote: "Explore diverse landscapes and challenging trails with our carefully curated routes."
    },
    {
      title: "Unforgettable Scenery",
      icon: sceneryIcon,
      alt: "scenery-icon",
      quote: "Immerse yourself in breathtaking nature and views that will stay with you forever."
    }
  ];
...
const reviews: {
...
}[] = [
  {
    ...
    title: "",
    content:
      "A perfect experience! Beautiful nature and the most beautiful sunset. I will definitely come again.😍",
    author: "Lucia",
  },
  {
    rating: 5,
  ...
  },
  {
    ...
    title: "",
    content:
      "An ideal way to spend a day on Hvar. All recommendations from the heart. See you again! :)",
    author: "Ivana Šolić",
  },
  {
    rating: 5,
    title: "",
    content:
      "Very good quad rental agency. Also provides a map with the beaches to visit, some typical restaurants and tours to do",
    author: "Kévin Racca",
  },
];
  ...
  return (
    <>
      <div className="flex flex-col gap-8 mb-24">
        <div>
          <p className="text-3xl text-center mx-4 font-extrabold mb-12 italic">
            Why Choose CroQuad?
          </p>
        </div>
        <div>
          <p className="text-center text-3xl mx-4 my-16 font-medium">
            We craft{" "}
            <span className=" text-red-600 font-semibold underline italic">
              experiences
            </span>
            , not just journeys!
          </p>
        </div>
        <div className="flex flex-col items-center justify-center lg:flex-row gap-24 mx-4 mt-12">
      {features.map((feature, index) => (
        <div 
          key={index} 
          className="flex flex-col items-center w-full max-w-xs h-80 gap-6 sm:text-center rounded-xl border-2 p-6 bg-zinc-50"
        >
          ...
          <div className="flex items-center justify-center h-24">
            <Image
              ...
              width={90}
              height={50}
              className="m-auto object-contain mix-blend-multiply"
            />
          </div>
          <q className="text-center text-lg mx-4 italic">
            {feature.quote}
          </q>
        </div>
      ))}
          ...
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-3 lg:items-center lg:gap-16">
            <div className="max-w-xl text-center ltr:sm:text-left rtl:sm:text-right">
              ...
              <p className="mt-4 text-xl text-gray-700">
                More reviews on{" "}
                <a
                  href={"https://g.co/kgs/WpScwR1"}
                  target="_blank"
                  className="text-blue-600 font-semibold after:content-['_↗']"
                >
                  Google
                </a>
              </p>
              ...
              <div id="keen-slider" className="keen-slider">
                {reviews.map((review, index) => (
                  <div key={index} className="keen-slider__slide">
                    <blockquote className="flex h-full flex-col justify-between p-6 shadow-sm sm:p-8 lg:p-12 border-2 rounded-xl bg-zinc-50">
                      <div>
                      ...
                      <footer className="mt-4 text-sm font-medium text-gray-700 italic">
                        &mdash; {review.author}
                      </footer>
                    </blockquote>
                  </div>
