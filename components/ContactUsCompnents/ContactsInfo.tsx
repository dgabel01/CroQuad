...
const ContactsInfo = () => {
  return (
    ...
    <div className='flex flex-col gap-8 items-center justify-center my-16'>
        <p className='text-2xl mx-4 font-extrabold text-center'>1) Phone number(or the WhatsApp button in the bottom corner):</p>
        <p className='text-3xl text-blue-400 mb-4 mx-4 font-bold '>+385 91 536 83381</p>
