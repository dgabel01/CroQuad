  ...
  return (
    <>
      ...
      <Accordion placeholder="" open={open === 1} icon={<Icon id={1} open={open} />}>
        <AccordionHeader placeholder="" onClick={() => handleOpen(1)}>What are the requirements to rent a quad?</AccordionHeader>
        <AccordionBody>
      ...
      <Accordion placeholder="" open={open === 2} icon={<Icon id={2} open={open} />}>
        ...
        Are reservations required, and how can I book a quad rental?
        </AccordionHeader>
        <AccordionBody>
          We&apos;re not always in the position that we want to be at. We&apos;re constantly
          growing. We&apos;re constantly making mistakes. We&apos;re constantly trying to express
