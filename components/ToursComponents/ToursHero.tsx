   ...
   <div className="relative overflow-hidden bg-cover bg-no-repeat" style={{
      ...
      <div className="absolute top-0 right-0 bottom-0 left-0 h-full w-full overflow-hidden bg-[hsla(0,0%,0%,0.50)] bg-fixed">
        <div className="flex h-full items-center justify-center">
          <div className="px-6 sm:mt-16 m-4 text-center text-white md:px-12">
            <h1 className="mt-2 mb-24 text-4xl font-bold tracking-tight md:text-5xl xl:text-6xl">
              Adventure Awaits
            </h1>
            <p className='text-3xl mb-8 font-bold'>Embark on unforgettable journeys with CroQuad</p>
            <Link href={"/contact"}>
              <button type="button"
